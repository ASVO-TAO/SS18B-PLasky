"""
Django settings for bilbyui project.
...
SECRET_KEY = 'f&m_t%_&sacn=6tuq8o2b15ax=-&&#zwtwf1%*b5%-l0^eztmc'
...
WSGI_APPLICATION = 'bilbyui.wsgi.application'

# Database
# https://docs.djangoproject.com/en/2.0/ref/settings/#databases
# UPDATED by the development or production or local settings files
DATABASES = {
    'default': {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'bilbyui.log'),
            'formatter': 'standard',
            'when': 'midnight',
            'interval': 1,
        },
