...
FIELDSETS = OrderedDict([
    (FREQUENCY, [FREQUENCY, ]),
    (BAND, [BAND, ]),
    (A0_SEARCH, [A0_START_SEARCH, A0_END_SEARCH, A0_BINS_SEARCH, ]),
    (ORBIT_TP_SEARCH, [ORBIT_TP_START_SEARCH, ORBIT_TP_END_SEARCH, ORBIT_TP_BINS_SEARCH, ]),
    (ALPHA_SEARCH, [ALPHA_SEARCH, ]),
    (DELTA_SEARCH, [DELTA_SEARCH, ]),
    (ORBIT_P_SEARCH, [ORBIT_P_SEARCH, ]),
])
