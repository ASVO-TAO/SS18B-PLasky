...
class Bilby(Slurm):
    ...
    def submit(self, job_parameters):
        ...
        # Now replace the output paths to various data products with the correct JOBFS paths
        job_parameters['datasource']['datadir'] = "%{ENV_JOBFS}/data"
        job_parameters['engine']['atomcache'] = "%{ENV_JOBFS}/atoms"
        job_parameters['output']['dir'] = "%{ENV_JOBFS}/output"
