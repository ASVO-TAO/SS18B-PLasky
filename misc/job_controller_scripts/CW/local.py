...
HPC_DAEMON_PID_FILE = '/tmp/bilbycw_job_controller.pid'

# The remote web address of the websocket server (ws(s)://host:port)
HPC_WEBSOCKET_SERVER = 'wss://supercomputing.swin.edu.au/projects/bilbygw/live/ws/'

# The scheduler class
HPC_SCHEDULER_CLASS = 'settings.bilby_slurm.Bilby'

# The location of job working directory
HPC_JOB_WORKING_DIRECTORY = '/fred/oz022/bilby_cw/jobs/'
